...
\item Profesores:
  \begin{itemize}
  \item Jesús M. González Barahona (jesus.gonzalez @ urjc.es)
  \item David Moreno Lumbreras (david.morenolu @ urjc.es)
  \item Gregorio Robles (grex @ gsyc.urjc.es)
  \item Juan González Gómez ( juan.gonzalez.gomez @ urjc.es)
  \end{itemize}
\item Grupo de Sistemas y Comunicaciones (GSyC)
\item Horario: \horario
\item Tutoría: Jueves 17:00-19:00 (via videoconferencia)
\end{itemize}
...
\includegraphics[width=6cm]{figs/2025-most-popular-lang-github}
\end{center}
...
%-----------------------    ---------------------------------
\begin{frame}
\frametitle{Fundamentos de la asignatura (3)}

\vspace{5.4cm}

\begin{center}
  \Huge La IA generativa está aquí \\
  para quedarse \\
\end{center}
