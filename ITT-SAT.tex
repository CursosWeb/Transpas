...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\includeonly{presentacion-sat-saro,cookies,rest,mvc,xml,css,ajax,python,django}
%\includeonly{cookies}
%\includeonly{rest}
%\includeonly{mvc}
%\includeonly{xml}
...
\begin{footnotesize}
\copyright 2002-2020 Jesús M. González Barahona, Gregorio Robles y
Jorge Ferrer. \\
