...
str(b"These are bytes", 'utf-8') # utf-8 is the encoding
\end{verbatim}
\end{footnotesize}
...
\begin{verbatim}
  ...
  File "<stdin>", line 1
    hola ="Hello World
                      ^
SyntaxError: EOL while scanning string literals
\end{verbatim}
\end{footnotesize}
...
\begin{itemize}
  ...
  \item \verb|input()|  acepta un valor (string) desde teclado
\end{itemize}
...
¡La misma sintaxis se aplica a las cadenas!
  ...
  \begin{footnotesize}
\begin{verbatim}
a_string = "un pincho de tortilla"
print(a_string[-1])
\end{verbatim}
  \end{footnotesize}
...
if integer:
     print('This is true')
     print('And this gets also printed')
else:
     print('false')
     print('This only gets printed if false')
print('This is after the if and always get printed')
\end{verbatim}
\end{footnotesize}


  \item Para enteros: todo lo que no sea cero es \emph{True}
