...
\begin{itemize}
  \item Utilizando Google Maps para ver las antípodas \\ \url{http://www.antipodemap.com/}
  ...
  \item Creando un Comecocos \\ \url{http://www.canvasdemos.com/2010/07/30/pacman/}
  \item Creando webs modernas y ubicuas \\ \url{http://gsyc.es/~grex/leonardo/}
  \item ...
\end{itemize}
