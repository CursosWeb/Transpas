...
\begin{itemize}
\item Usaremos la versión 1.6.2
...
\begin{verbatim}
tar xvzf Django-1.6.2.tar.gz
\end{verbatim}
\end{itemize}
\begin{flushright}
{\small
\url{http://docs.djangoproject.com/en/dev/topics/install/}
\url{http://www.djangoproject.com/download/1.6.2/tarball/}
}
\end{flushright}
...
\item INSTALLED\_APPS (en settings.py) ha de incluir:
  ...
  \end{itemize}
\item Hay que crear las tablas pertinentes (manage.py syncdb)
\end{itemize}
\end{frame}
