...
\begin{itemize}
  \item El proceso de migracinoes se encarga de la propagación de modificaciones en el modelo (p.ej., añadir/borrar un campo)
...
%  \item \texttt{sqlmigrate}: muestra las instrucciones SQL de la migración.
  \item Los archivos para las migraciones se encuentran en el directorio \texttt{migrations} de las aplicaciones. Se crean automáticamente con \texttt{makemigrations}, aunque se pueden modificar a mano.
\end{itemize}
