...
\begin{itemize}
\item Usaremos una versión de Django 1.8 instalada en los laboratorios, ya que se trata de una versión \emph{LTS} (\emph{Long Term Support})
...
\item Comprobación (debe responder 1.8.*):
\begin{verbatim}
