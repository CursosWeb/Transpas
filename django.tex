...
\begin{itemize}
\item Usaremos una versión de Django 2.0 instalada en los laboratorios
%, ya que es la versión \emph{LTS} (\emph{Long Term Support})
...
\item Comprobación (debe responder 2.0.*):
\begin{verbatim}
...
\begin{itemize}
\item En el fichero urls.py (de la aplicación): \verb|myfirstapp/urls.py|
...
%%---------------------------------------------------------------
\begin{frame}[fragile]
\frametitle{Declaración de URLs: \verb|path()|}
...
\item Cada aplicación tiene su models.py
  ...
  \item __str__() da una representación del objeto (p.ej., un campo)
  \item Ejemplo:
\begin{verbatim}
