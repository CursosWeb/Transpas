...
%% Metadatos del PDF.
\hypersetup{
  pdftitle={Servicios y Aplicaciones en Redes de Ordenadores},
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\includeonly{presentacion-web,cookies,python}
%\includeonly{cookies}
%\includeonly{rest}
%\includeonly{mvc}
%\includeonly{xml}
...
\title{Servicios y Aplicaciones en Redes de Ordenadores (2014-2015)}
\subtitle{Grado en Sistemas de Telecomunicación (URJC)}
